...
export default function About () {
  const translation = useTranslations('index.about');

  return (
    <section className="w-full h-dvh text-white md:bg-[url(/images/light-point-about-right.svg)] bg-no-repeat bg-right-top max-lg:bg-[auto_13.5%]">
      <h1 className="pt-4 md:pt-10 pl-10 text-3xl">_{translation('title')}</h1>
      <div className="w-full h-5/6 relative md:static flex flex-col md:flex-row-reverse items-center md:justify-between pt-20 md:bg-[url(/images/light-point-about-left.svg)] max-lg:bg-[auto_50%] bg-left bg-no-repeat">
        ...
        <p 
          className="md:flex justify-center items-center w-10/12 md:w-2/3 lg:w-1/2 h-full md:h-1/2 mt-28 min-[430px]:mt-36 min-[500px]:mt-44 md:mt-0 pt-24 md:pt-0 pl-5 pr-5 pb-8 md:pb-0 text-md sm:text-lg md:text-sm lg:text-xl text-center md:text-left bg-[#5505AB33] border-b-4 border-r border-[#8348F4] md:border-r-0 md:rounded-r-[100px]"
        >
